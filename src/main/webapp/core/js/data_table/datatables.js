 ...
 *   https://datatables.net/download/#dt/jq-2.1.4,dt-1.10.9,cr-1.2.0,fh-3.0.0,r-1.0.7,sc-1.3.0
 *
 * Included libraries:
 *   jQuery 2.1.4, DataTables 1.10.9, ColReorder 1.2.0, FixedHeader 3.0.0, Responsive 1.0.7, Scroller 1.3.0
 */
...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append( $('<label/ id="'+tableId+'_label_search">' ).append( str ) ).append('<button id="' + tableId + '_button_search" type="button" class="cm-search-button">'+
	...
	function _fnInitialise ( settings )
	{
		...
		var tableName = settings.aanFeatures.t[0].id;
		if ($("#" + tableName + "_label_search").find('input').val() === "") {
			$("#" + tableName + "_label_search").hide();
		}
        $( "#"+tableName+"_button_search").click(function() {
            $( "#"+tableName+"_label_search").toggle("slow");
            $( "#"+tableName+"_label_search").focus();
        });
...
jQuery.fn.dataTable.ext.builder = "dt\/jq-2.1.4,dt-1.10.9,cr-1.2.0,fh-3.0.0,r-1.0.7,sc-1.3.0";
