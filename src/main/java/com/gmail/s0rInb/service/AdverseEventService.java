...
public class AdverseEventService {
	...
	private HashMap prepareAdverseEventToPdf(AdverseEvent adverseEvent) {
		...
		if (adverseEvent.getLethalDate() != null)result.put("lethalDate", adverseEvent.getLethalDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
	...
	private HashMap fourToHashMap(Four four, String s){
		...
		if (four.getStartDate() != null)result.put(s + "startDate", four.getStartDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
		if (four.getEndDate() != null)result.put(s + "endDate", four.getEndDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
	...
	private HashMap fiveToHashMap(Five five, String s){
		...
		if (five.getStartDate() != null)result.put(s + "startDate", five.getStartDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
		if (five.getResult() != null)result.put(s + "result", five.getResult().toString());
		if (five.getEndDate() != null)result.put(s + "endDate", five.getEndDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
	...
	private HashMap sixToHashMap(Six six, String s){
		...
		if (six.getStartDate() != null)result.put(s + "startDate", six.getStartDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
		if (six.getEndDate() != null)result.put(s + "endDate", six.getEndDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
		return result;
	}
	private HashMap sevenToHashMap(Seven seven, String s){
		...
		if (seven.getDate() != null)result.put(s + "date", seven.getDate().format(DateTimeFormatter.ofPattern("dd LLLL yyyy")));
		return result;
	}
}
